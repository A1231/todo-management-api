...
import com.todos.todos.service.AdminService;
...
public class AdminController {
    ...
    @Operation(summary = "Promote user to admin", description="Promote user to admin")
    @ResponseStatus(HttpStatus.OK)
    ...
    @Operation(summary = "Delete user", description="Delete non-admin user")
